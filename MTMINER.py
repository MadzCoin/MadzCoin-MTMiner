...
miner_config.nodes = ["https://78.58.45.205:5000", "http://2.97.29.184:6969"]
...
miner_config.explorer_addr_URL = "http://madzcoin-explorer.aj.do/address.html?address="
...
class MadzCoinMiner(object):
    ...
    def multiMine(self, NUM_THREADS):
        ...
        hashrate_table = ""
        rgbPrint(f"Started mining for: {self.rewardsRecipient} on: {self.preferred_node}", "cyan")
        msg = requests.get(self.preferred_node).json()
        rgbPrint(f"Node MOTD : {msg}!\n", "cyan")
